                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-mortar-board" data-icon="7"></i> <span class="hide-menu">&nbsp;&nbsp;<?php echo get_phrase('Manage Academics');?> <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level <?php
                            if ($page_name == 'enquiry_category'    ||
                                $page_name == 'enquiry_view'        ||
                                $page_name == 'school_clubs'        ||
                                $page_name == 'manage_circular'     ||
                                $page_name == 'manage_holiday'      ||
                                $page_name == 'manage_moraltalk'    ||
                                $page_name == 'syllabus'            ||
                                $page_name == 'manage_helplink'     ||
                                $page_name == 'manage_helpdesk'     ||
                                $page_name == 'registration_code'   
                                ) echo 'opened active';
                            ;?>">

                            <li class="<?php
                            if ($page_name == 'enquiry_category') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/enquiry_category"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('Enquiry Category'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'enquiry_view') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/enquiry_view"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('View Enquiries'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'school_clubs') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/school_clubs"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('School Clubs'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'manage_circular') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/manage_circular"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('Manage Circular'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'manage_holiday') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/manage_holiday"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('Manage Holiday'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'manage_moraltalk') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/manage_moraltalk"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('Manage Moraltalk'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'syllabus') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/syllabus"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('Syllabus'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'manage_helplink') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/manage_helplink"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('Manage Helplink'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'manage_helpdesk') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/manage_helpdesk"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('Manage Helpdesk'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'registration_code') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/registration_code"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('Registration Code'); ?></span></a> </li>

                            <li class="<?php
                            if ($page_name == 'enquiry_setting') echo 'active';
                            ;?>">
                            
                            <a href="<?php echo base_url();?>admin/enquiry_setting"><i class="fa fa-angle-double-right p-r-10"></i><span class="hide-menu"><?php echo get_phrase('Enquiry Category'); ?></span></a> </li>
